...
public class WantToReadFragment extends Fragment implements OnBookListener, BookAdapter.OnBookDeleteListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        recyclerView = view.findViewById(R.id.want_to_read_recycler_view);
    ...
    private void observeBooks() {
        libraryViewModel.getBooksByStatus("WANT_TO_READ").observe(getViewLifecycleOwner(), books -> {
            if (books != null) {
