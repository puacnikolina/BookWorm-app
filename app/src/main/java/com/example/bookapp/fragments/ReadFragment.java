...
public class ReadFragment extends Fragment implements OnBookListener, BookAdapter.OnBookDeleteListener {
    ...
    private void observeBooks() {
        libraryViewModel.getBooksByStatus("READ").observe(getViewLifecycleOwner(), books -> {
            if (books != null) {
